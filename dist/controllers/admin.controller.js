...
exports.adminController = {
    getDashboardStats: async (req, res) => {
        try {
            const [totalUsers, totalCompanies, totalJobs, totalApplications, recentUsers, recentJobs, recentApplications,] = await Promise.all([
                prismaClient.user.count({ where: { role: client_1.UserRole.USER } }),
                prismaClient.user.count({ where: { role: client_1.UserRole.COMPANY } }),
    ...
    manageJobPostings: async (req, res) => {
        try {
